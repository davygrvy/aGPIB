...
/*
 * This ensures that the Agpib_InitStubs has a prototype in
 * aGPIB.hpp and is not the macro that turns it into Tcl_PkgRequire
 */

#ifndef USE_AGPIB_STUBS
#define USE_AGPIB_STUBS
#endif

#include "aGPIBInt.h"

AgpibStubs	*agpibStubsPtr;
AgpibIntStubs	*agpibIntStubsPtr;
...
CONST char *
Agpib_InitStubs(interp, version, exact)
    Tcl_Interp *interp;
    CONST char *version;
    int exact;
{
    ...
    actualVersion = Tcl_PkgRequireEx(interp, "aGPIB", version, exact,
